<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Spots.aspx.cs" Inherits="Web.Spots" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <section class="content clearfix">
                                ...
                                <li class="item_li">
                                    <div class="img_wrap">
                                        <div class="recommend_img">
                                            <a href="SpotDetails.aspx?id=<%# Eval("Id") %>" target="_blank">
                                                <img src="<%# Eval("Img") %>" alt="象山景点" width="295px" height="195px"></a>
                                        </div>
                                        <div class="recommend_title">
                                            <a href="SpotDetails.aspx?id=<%# Eval("Id") %>" target="_blank"><%# Eval("Title") %></a>
                                        </div>
                                    </div>
                                    <div class="li_title">
                                        <a href="SpotDetails.aspx?id=<%# Eval("Id") %>" target="_blank"><%# Eval("TitleFu") %></a>
                                    </div>
                                </li>
                            </ItemTemplate>
                        </asp:Repeater>
            ...
            <!-- 图片列表end -->
            <!-- 页码begin -->
            <article class="pages clearfix pd50">
                <table class="MovePage" style="width:100%;" cellpadding="0" cellspacing="0" border="0" align="center">
                    <tr>
                        <td height="30">
                            <div class="page">
                                <div class="sort_list">
